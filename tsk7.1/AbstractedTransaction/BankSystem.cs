...
namespace AbstractedTransaction
{
    ...
    class BankSystem
    {
        ...
        private static Transaction ChooseTransaction (Bank bank)
        {
            ...
            do
            {
                inputIndex = InputToInt(Console.ReadLine());
        ...
        private static void DoRollback(Bank bank)
        {
            ...
            Console.WriteLine("Which transaction to rollback?");
            Transaction transaction = ChooseTransaction(bank);
